 ...
 * @author asus
 */
@WebServlet(name = "BuscarIDOV", urlPatterns = {"/BuscarIDOV"})
public class BuscarIDOV extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!lista.isEmpty()){
            ...
            response.sendRedirect("Ventas/ModificarOrdenVenta.jsp");
        }else{
            request.getSession().setAttribute("motivo", "La orden de venta NO existe");
            response.sendRedirect("Ventas/ErrorIDOV.jsp");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BuscarIDOV.class.getName()).log(Level.SEVERE, null, ex);
