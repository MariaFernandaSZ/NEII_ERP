 ...
 * @author asus
 */
@WebServlet(name = "BuscarIDOVpago", urlPatterns = {"/BuscarIDOVpago"})
public class BuscarIDOVpago extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String ordenventa = request.getParameter("IDpago");
        ...
        if(!lista.isEmpty()){
            ...
            response.sendRedirect("Ventas/Formadepago.jsp");
        }else{
            request.getSession().setAttribute("motivo", "La orden de venta NO existe");
            response.sendRedirect("Ventas/ErrorPago.jsp");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                ...
                Logger.getLogger(BuscarIDOVpago.class.getName()).log(Level.SEVERE, null, ex);
            }
