 ...
 * @author maxim
 */
@WebServlet(name = "LibroDiarioPdf", urlPatterns = {"/LibroDiarioPdf"})
public class LibroDiarioPdf extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(LibroDiarioPdf.class.getName()).log(Level.SEVERE, null, ex);
