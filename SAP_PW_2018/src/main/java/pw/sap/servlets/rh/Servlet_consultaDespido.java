 ...
 */
@WebServlet(name = "Servlet_consultaDespido", urlPatterns = {"/Servlet_consultaDespido"})
public class Servlet_consultaDespido extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        c.insercionRegistro((int)sesion.getAttribute("usuario"), (String)sesion.getAttribute("area"), "consulta de empleados despedidos.");
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Servlet_consultaDespido.class.getName()).log(Level.SEVERE, null, ex);
