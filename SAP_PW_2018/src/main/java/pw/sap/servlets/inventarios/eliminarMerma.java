 ...
 */
@WebServlet(name = "eliminarMerma", urlPatterns = {"/eliminarMerma"})
public class eliminarMerma extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(eliminarMerma.class.getName()).log(Level.SEVERE, null, ex);
