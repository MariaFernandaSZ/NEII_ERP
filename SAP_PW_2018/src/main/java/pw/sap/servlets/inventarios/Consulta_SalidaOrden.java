 ...
 * @author montse
 */
@WebServlet(name = "Consulta_SalidaOrden", urlPatterns = {"/Consulta_SalidaOrden"})
public class Consulta_SalidaOrden extends HttpServlet {
     ...
     */
        ...
        ArrayList l=c.consultaSalidasOrden(Integer.parseInt(request.getParameter("id_ordenventa")));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            try {
                ...
                Logger.getLogger(Consulta_SalidaOrden.class.getName()).log(Level.SEVERE, null, ex);
