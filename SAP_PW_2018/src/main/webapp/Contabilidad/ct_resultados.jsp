                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><!-- Seccion central -->
                        <div class="table-responsive">
                            <form action="ct_resultados.html" onsubmit="return estado();" method="post">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="date" id="Estfechaini" />
                                            <input type="date" id="Estfechafin" />
                                        </td>
                                        <td>
                                            <select id="reporte">
                                                <option value="x">Selecciona...</option>
                                                <option value="1">gastos generales</option>
                                                <option value="2">reporte operativo</option>
                                                <option value="3">resultado operativo</option>
                                            </select>                                    
                                        </td>
                                    </tr>
                                </table> 
