        ...
        <header class="sticky-top"> 
            <nav id="barraNavegadora" class="navbar navbar-expand-lg colorPrincipal" >
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                        <a href="ayuda_despedir.jsp" class="nav-link text-white" target="_blank" style="color: white" aria-haspopup="true" aria-expanded="false"><img class="ic" border="0" height="25" width="25" src="../../archivos/img/ic_ayuda.png" /><p>Ayuda</p></a>
                    </li>
    ...
    <tr><td align='center' class='form-group'>
            <form autocomplete='off' method="POST" id="formdespedirEmpleado" action="../../Servlet_despedirEmpleado" >
                <table style="margin: 0 auto;" >
                    ...
                    <tr><td>ID&nbsp;empleado</td><td><input type='number' placeholder="id empleado" id='despedirIdEmpleado' name='despedirIdEmpleado' class='form-control form-control-sm' required></td></tr>
