    ...
    <tr><td align='center' class='form-group'>
            <form autocomplete='off' method="POST" id="formAgregarTarea" action="../../Servlet_agregarTarea">
                <table style="margin: 0 auto;">
                    ...
                    <tr><td align='left'><label>ID&nbsp;del&nbsp;Empleado:&nbsp;</label></td><td><input type='text' id='agregarResponsable' name='agregarResponsable' class='form-control form-control-sm' required></td></tr>
