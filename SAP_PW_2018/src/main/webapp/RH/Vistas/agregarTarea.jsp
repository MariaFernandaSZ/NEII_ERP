<table class='tabla'>
    <tr><td align='center' class='form-group'>
            <form autocomplete='off' method="POST" id="formAgregarTarea" action="../../Servlet_agregarTarea">
                <table style="margin: 0 auto;">
                    <tr><td align='center' colspan='2'><h1 style='text-align:center;'>AGREGAR&nbsp;UNA&nbsp;TAREA</h1></td></tr>
                    <tr><td align='left'><label>ID&nbsp;del&nbsp;Responsable:&nbsp;</label></td><td><input type='text' id='agregarResponsable' name='agregarResponsable' class='form-control form-control-sm' required></td></tr>
