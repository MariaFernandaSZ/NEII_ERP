    ...
    <tr><td align='center' class='form-group'>
            <form autocomplete='off' method="POST" id="formAgregarTarea" onsubmit="return agregarTarea();" >
                <table style="margin: 0 auto;">
                    ...
                    <tr><td align='left'><label>Nombre&nbsp;de&nbsp;la&nbsp;Tarea:&nbsp;</label></td><td><input type='text' id='agregarNombreTarea' placeholder="agregar nombre de tarea" name='agregarNombreTarea' class='form-control form-control-sm' required></td></tr>
                    <tr><td align='left'><label>ID&nbsp;del&nbsp;Empleado:&nbsp;</label></td><td><input type='number' id='agregarResponsable' name='agregarResponsable' placeholder="responsable" class='form-control form-control-sm' required></td></tr>
