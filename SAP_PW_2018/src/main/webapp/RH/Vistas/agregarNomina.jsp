    ...
    <tr><td align='center' class='form-group'>
            <form autocomplete='off' method="POST" id="formAgregarNomina" onsubmit="return agregarNomina();" action="../../Servlet_agregarNomina">
                <table style="margin: 0 auto;">
                    ...
                    <tr><td align='left'><label>Empresa: &nbsp; </label></td><td><input type='text' id='empresa' name='empresa' placeholder="ingrese nombre de empresa" class='form-control form-control-sm' required></td></tr>
                    ...
                    <tr><td align='left'><label>ID&nbsp;de&nbsp;Empleado:&nbsp;</label></td><td><input type='number' id='idEmpleado' placeholder="ingresa id del empleado" name='idEmpleado' class='form-control form-control-sm' required></td></tr>
                    <tr><td align='left'><label>Percepciones:&nbsp; </label></td><td><input type='number' id='percepciones' name='percepciones' placeholder="percepcciones" class='form-control form-control-sm' required></td></tr>
                    <tr><td align='left'><label>Deducciones:&nbsp; </label></td><td><input type='number' id='deducciones' name='deducciones' placeholder="deducciones" class='form-control form-control-sm' required></td></tr>
                    <tr><td align='left'><label>D&iacute;as&nbsp;Pagados:&nbsp; </label></td><td><input type='number' id='diasPagados' placeholder="numero de dias pagados" name='diasPagados' class='form-control form-control-sm' required></td></tr>
                    <tr><td align='left'><label>Sueldo por d&iacute;a</label></td><td><input type='number' id='contratarSueldoDiario' placeholder="salario al dia" name='contratarSueldoDiario' class='form-control form-control-sm' required></td></tr>
                    <tr><td align='left'><label>Forma&nbsp;de&nbsp;Pago:&nbsp;</label></td><td><input type='text' id='formaPago' placeholder="foma de pagar" name='formaPago' class='form-control form-control-sm' required></td></tr>
