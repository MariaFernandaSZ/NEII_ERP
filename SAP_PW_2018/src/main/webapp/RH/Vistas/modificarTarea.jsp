    ...
    <tr>
        <td align='center' class='form-group'>
            <form autocomplete='off' method="POST" id="formModificarTarea" action="../../Servlet_modificarTarea">
                ...
                <table style="margin: 0 auto;">
                    <tr><td><input type='checkbox' name='info[]' id='chEncargado' value='chIdEmpleado'></td><td><label class="form-check-label" for='chIdEmpleado'>&nbsp;ID del empleado: </label></td><td><input type='number' id='modificarIdEmpleado' name='modificarIdEmpleado' class='form-control form-control-sm'></td></tr>
                    ...
                    <tr><td><input type='checkbox' name='info[]' id='chFechat' value='chFechat'></td><td><label class="form-check-label" for='chFechat'>&nbsp;Fecha de Fin: </label></td><td><input type='date' id='modificarFechaFin' name='modificarFechaFin' class='form-control form-control-sm'></td></tr>
