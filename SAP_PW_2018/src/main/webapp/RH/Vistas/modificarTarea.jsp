                ...
                <form autocomplete='off' method="POST" id="formModTarea" action="../../Servlet_modBuscaTarea">
                    ...
                    <table style="margin: 0 auto;">
                        <tr>
                            ...
                            <td><input type='number' min="1" id='modificarIdTarea' placeholder="ingresa id de la tarea" name="modificarIdTarea" class='form-control form-control-sm' required></td>
                        </tr>
                        <tr>
