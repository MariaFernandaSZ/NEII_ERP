    ...
    <tr><td align='center' class='form-group'>
            <form autocomplete="off" method="POST" id="formEliminarTarea"  onsubmit='return eliminarTarea();'>
                <table style="margin: 0 auto;">
                    ...
                    <tr><td align='right'><label>Id&nbsp;de&nbsp;la&nbsp;Tarea:&nbsp;</label></td><td><input type='number' id='eliminarIdTarea' placeholder="ingrese id de la tarea" name='eliminarIdTarea' class='form-control form-control-sm'></td></tr>
                    <tr><td align='right'><label>Nombre&nbsp;de&nbsp;la&nbsp;Tarea:&nbsp;</label></td><td><input type='text' id='eliminarNombreTarea' placeholder="ingrese nombre de la tarea" name='eliminarNombreTarea' class='form-control form-control-sm'></td></tr>
