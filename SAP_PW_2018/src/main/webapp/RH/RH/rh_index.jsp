                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="rh_navbar">
                                <ul class="navbar-nav mr-auto">
                                    <li class="nav-item"><a href="#" id="verCalendario" class="nav-link text-white color">Ver&nbsp;calendario</a></li>
                                    <li class="nav-item"><a href="#" id="agregarTarea" class="nav-link text-white color">Agregar&nbsp;tarea</a></li>
                                    <li class="nav-item"><a href="#" id="eliminarTarea" class="nav-link text-white color">Eliminar&nbsp;tarea</a></li>
                                    <li class="nav-item"><a href="#" id="modificarTarea" class="nav-link text-white color">Modificar&nbsp;tarea</a></li>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu departamento" aria-labelledby="nomina">
                                            <a class="nav-link text-white color" href="#" id="contabilidad_nomina">Contabilidad</a>
                                            <a class="nav-link text-white color" href="#" id="gerencia_nomina">Gerencia</a>
                                            <a class="nav-link text-white color" href="#" id="compras_nomina">Compras</a>
                                            <a class="nav-link text-white color" href="#" id="ventas_nomina">Ventas</a>
                                            <a class="nav-link text-white color" href="#" id="inventario_nomina">Inventario</a>
                                            <a class="nav-link text-white color" href="#" id="rh_nomina">Recursos&nbsp;Humanos</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown">
