...
<%
    ArrayList listaa = (ArrayList) request.getSession().getAttribute("ordenventa");
%>
<!DOCTYPE html>
<html>
    <head>
       ...
       <div class="container-fluid contenido">
            ...
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    <center><h1>Modificar Orden de Venta</h1></center>
                    <div class="form-style-5">
                        <form action="../ActualizarOrdenVenta" method="POST">
                            <div class="row">
                            ...
                            <div class="col-xs-4 col-md-4">
                                <font face="Comic Sans MS"><label for="id">ID Orden de Venta:</label></font>
                                <input type="number" class="form-control col-12" name="idov" id="idov" value="<%= listaa.get(0) %>" placeholder="ID" required="required" readonly="readonly">
                            </div>
                            <div class="col-xs-4 col-md-4">
                            ...
                            <div class="col-xs-4 col-md-4">
                                ...
                                <input type="date" class="form-control col-12" name="fechaOV" id="fechaOV" value="<%= listaa.get(1) %>" placeholder="Fecha" required="required">
                            </div>
                            <div class="col-xs-12 col-md-12">
                            <font face="Comic Sans MS"><label for="fecha">Descripción:</label></font>
                            <input type="text" class="form-control col-12" name="desOV" id="desOV" value="<%= listaa.get(2) %>" placeholder="" required="required">
                            </div>
                            <div class="col-xs-12 col-md-12">
                            ...
                            <input type="text" name="idcli" id="idcli"  required="required" placeholder="ID" value="<%= listaa.get(7) %>" readonly="readonly">
                            </div>
                            <div class="col-xs-4 col-md-4">
                            </div>
                            <div class="col-xs-12 col-md-12">
                            ...
                            <div class="col-xs-12 col-md-12">
                            <center><button type="submit" style="background-color:#045FB4" name="registrar" class="btn btn-primary">Modificar Orden de Venta</button></center>
                            </div>
                            </div>
                        </form>
                    </div>
