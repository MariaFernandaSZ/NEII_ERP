                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><!-- Seccion izquierda -->
                    ...
                    <div class="form-style-5">
                        <form>
                            ...
                            <span id="titulo"><span class="number">2</span>Venta en parcialidades</span><br>
                    ...
                    <div class="form-style-5">
                        <form>
                            ...
                            <center>
                                ...
                                <br><button type="button" name="pagar" style="background-color: #9F150D" onclick="validaFechasPARCIAL()" class="btn btn-danger">Pagar</button> <button type="button" name="cancelar" style="background-color: #9F150D" class="btn btn-danger">Cancelar</button>
                            </center>
                        </form>
                    </div>
