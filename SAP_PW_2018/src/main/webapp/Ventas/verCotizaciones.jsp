<%-- 
    Document   : verCotizaciones
    Created on : 07-may-2018, 1:44:56
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="#">Cotizaciones archivadas <span class="sr-only">(current)</span></a>
                            </div>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><!-- Seccion izquierda -->
                    ...
                    <div class="form-style-5">
                        <form>
                            <span id="titulo"><span class="number">1</span>Cotizaciones</span><br><br>
                            ...
                            <center>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="reportCotizaciones" id="report1" value="todasCotiza" checked >
                                    <label style="font-size: 18px" class="form-check-label" for="report1">
                                        Todas las cotizaciones
                                    </label>
                                </div>     
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="reportCotizaciones" id="report2" value="clientesCot">
                                    <label style="font-size: 18px" class="form-check-label" for="report2">
                                        Cotizaciones por clientes
                                    </label>
                                </div> <br>

                                <button type="button" name="cargaFacturas" style="background-color: #9F150D" onclick="validaFechasReportes()" class="btn btn-danger">Cargar cotizaci&oacute;n</button>
                            </center>
                        </form>
                    </div>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12"><!-- Seccion central TABLA -->
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th scope="col">Folio de cotizaci&oacute;n</th>
