            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="form-style-5">
                        ...
                        <br>
                        <div class="col-xs-12 col-md-12">
                            <center><button type="submit" style="background-color:#045FB4" name="buscar" class="btn btn-primary"><a href="Cobros.jsp"><h5><font color=white>Regresar</font></h5></a></button></center>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
