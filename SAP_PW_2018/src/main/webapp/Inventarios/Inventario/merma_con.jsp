            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><!-- Seccion izquierda -->
                ...
                <div class="form-style-5">
                    <form action="../../Consulta_Merma" method="POST">  
                            ...
                            <span class="idemp"><input type="text" name="IDMerma" id="IDMerma" placeholder="Id de Merma"  maxlength="7" title="El id debe ser de 7 digitos (n&uacute;meros )" required ></span> <input type="submit" name="BuscaMID"  style="background-color: #9F150D" class="btn btn-danger" value="Consultar" onclick="return fomCon()"/><br><br>
