        ...
        <!-- CONTENIDO-->
         <div class="container-fluid contenido">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><!-- Seccion izquierda -->
                ...
                <div class="form-style-5">
                    <form action="../../Consulta_Desconocida" method="POST">  
                            <span id="titulo"><span class="number">1</span> Consulta</span><br><br>
                            <span class="idemp"><input type="text" name="CoBa" id="CoBa" placeholder="Id de Merma" pattern="[0-9]{7}" maxlength="7" title="El id debe ser de 7 digitos (n&uacute;meros )" required ></span> <input type="submit" name="BuscaMID"  style="background-color: #9F150D" class="btn btn-danger" value="Consultar" onclick="return fomCon()"/><br><br>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12"> <!-- Seccion central TABLA -->
                   <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <td><%= request.getAttribute("fecha_merma")%></td>
                                <td><%= request.getAttribute("tipo_merma")%></td>
                                <td><%= request.getAttribute("cantidad_merma")%></td>
                                <td><%= request.getAttribute("observaciones")%></td>
                ...
                <div class="form-style-5">
                     <form method="POST" action="../../ConsultaE_MD" onsubmit="return EspecificaMC()"> 
                            <span id="titulo"><span class="number">1</span>Ingrese los Datos a consultar</span>
                                ...
                                <br><br><span>Id de merma:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="idemp"><input style="width: 180px; height: 30px;text-align: center;" type="text" placeholder="#######" name="IDMerma"  id="IDMerma" maxlength="7" pattern="[0-9]{7}" title="El id de devoluci&oacute;n debe ser de 7 digitos (n&uacute;meros)" required/></span><br><br>
